...
Predicting results of the [Speed Chess Championship 2024](https://www.chess.com/events/2024-speed-chess-championship-main-event) using **XGBoost** and **Monte-Carlo simulations**
...
> **Note:** 60% accuracy on blitz,bullet games translates to 87%+ accuracy on full matches (39 games each) due to the Law of Large Numbers — variance decreases as sample size increases.
